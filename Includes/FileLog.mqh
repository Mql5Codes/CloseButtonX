...
//--- check handle
   if(m_handle!=INVALID_HANDLE)
      return(FileWrite(m_handle,TimeToString(TimeCurrent(),TIME_DATE|TIME_MINUTES|TIME_SECONDS),"",value));
//--- failure
   return(0);
  }
...
//--- check handle
   if(m_handle!=INVALID_HANDLE && m_level<=level)
      return(FileWrite(m_handle,TimeToString(TimeCurrent(),TIME_DATE|TIME_MINUTES|TIME_SECONDS),levelString,value));
//--- failure
   return(0);
  }

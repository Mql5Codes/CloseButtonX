...
//  Comment("_Digits: ",_Digits," tickValue: ",tickValue," tickSize: ",tickSize," lotValue: ",lotValue," ",SymbolInfoInteger(_Symbol,SYMBOL_DIGITS)," ",SymbolInfoDouble(_Symbol,SYMBOL_POINT));
   double resultado = pontos*lotValue;
